...
#         user = DataUser.get_user_by_email(user_id)
#         if user:
#             return render_template("indexv2.html", name=user['name'])
#         else:
#             flash('User not found.', 'danger')
...
#                 if not confirm_password:
#                     errors['confirm_password_error'] = 'Konfirmasi password harus diisi.'
#                 return render_template('registLoginv2.html', errors=errors)
...
#     return render_template('registLoginv2.html')
...
#         else:
#             errors = {'login_error': 'Email atau password salah.'}
#             return render_template('loginRegistv2.html', errors=errors)

#     return render_template('loginRegistv2.html')
